...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='Pq122855',db='cviar')
...
def insert_data(sec_token,ip_add,host_name,dev_user,os_name_ver,latlong,city,state,country,act_name,act_mail,act_mob,name,email,res_score,timestamp,no_of_pages,reco_field,cand_level,skills,recommended_skills,courses,pdf_name):
    ...
    rec_values = (str(sec_token),str(ip_add),host_name,str(dev_user),os_name_ver,str(latlong),city,state,country,act_name,act_mail,act_mob,name,email,str(res_score),timestamp,str(no_of_pages),reco_field,cand_level,skills,recommended_skills,courses,pdf_name)
...
def run():
    ...
    table_sql = "CREATE TABLE IF NOT EXISTS " + DB_table_name + """
                    ...
                    act_mail varchar(50) NULL,
                    act_mob varchar(20) NULL,
                    Name varchar(500) NULL,
                    Email_ID VARCHAR(500) NULL,
                    resume_score VARCHAR(8) NULL,
                    Timestamp VARCHAR(50) NULL,
                    Page_no VARCHAR(5) NULL,
                    Predicted_Field BLOB NULL,
                    User_level BLOB NULL,
                    Actual_skills BLOB NULL,
                    Recommended_skills BLOB NULL,
                    Recommended_courses BLOB NULL,
    ...
    tablef_sql = "CREATE TABLE IF NOT EXISTS " + DBf_table_name + """
                    (ID INT NULL AUTO_INCREMENT,
                        ...
                        feed_email VARCHAR(50) NULL,
                        feed_score VARCHAR(5) NULL,
    ...
    if choice == 'User':
        ...
        location = geolocator.reverse(latlong, language='ru')
